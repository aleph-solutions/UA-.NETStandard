...
namespace PMIE.PubSubOpcUaServer.Configuration
{
    ...
    public class PubSubObjectDataConfiguration
    {
        ...
        /// <summary>
        /// The key frame count as defined by PubSub specification
        /// </summary>
        [DataMember]
        public uint KeyFrameCount { get; set; }

        public PubSubObjectDataConfiguration()
        {
            if (uint.TryParse(Environment.GetEnvironmentVariable("KEYFRAMECOUNT"), out uint keyFrameCount))
