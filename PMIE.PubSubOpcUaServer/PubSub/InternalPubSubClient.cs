...
namespace PMIE.PubSubOpcUaServer.PubSub
{
    ...
    /// </summary>
    public class InternalPubSubUaClient
    {
        ...
        public string AddNewSecurityGroup(string name, out Opc.Ua.PubSub.Definitions.SecurityGroup securityGroup)
        {
            ...
            try
            {
                ...
                securityGroup = new Opc.Ua.PubSub.Definitions.SecurityGroup
                {
                    GroupName = name,
        ...
        /// </summary>
        public ObservableCollection<Opc.Ua.PubSub.Definitions.SecurityGroup> GetSecurityGroups()
        {
            ObservableCollection<Opc.Ua.PubSub.Definitions.SecurityGroup> securityGroups = new ObservableCollection<Opc.Ua.PubSub.Definitions.SecurityGroup>();
                    ...
                    foreach (ReferenceDescription referenceDescription in referenceDescriptionCollection)
                    {
                        if (referenceDescription.TypeDefinition == Constants.SecurityGroupNameTypeDefinitionId)
                        {
                            try
                            {
                                ...
                                securityGroups.Add(
                                                    new Opc.Ua.PubSub.Definitions.SecurityGroup()
                                                    {
        ...
        private void LoadApplicationInstance()
        {
            ApplicationInstance m_applicationInst = new ApplicationInstance
            {
                ...
                ConfigSectionName = "Opc.Ua.PubSub"
            };
